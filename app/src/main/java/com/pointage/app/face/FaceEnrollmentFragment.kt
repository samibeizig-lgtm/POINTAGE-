...
class FaceEnrollmentFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Afficher le moteur de reconnaissance actif
        val engine = if (FaceNetHelper.isAvailable()) "FaceNet IA ✓" else "Geometrique"
        binding.tvInstruction.text = "Moteur: $engine\nPlacez-vous face a la camera puis appuyez Capturer"
    ...
    private fun processImageForEnrollment(imageProxy: ImageProxy) {
        val bitmap = imageProxy.toBitmap() ?: run { imageProxy.close(); isCapturing = false; return }
